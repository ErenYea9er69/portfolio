...
export const metadata: Metadata = {
  ...
  description: `${DATA.name} — Full Stack Developer from Tunisia specializing in React, Next.js, TypeScript and Node.js. Explore my projects and portfolio.`,
  keywords: [DATA.name, "Full Stack Developer", "React Developer", "Next.js Developer", "TypeScript Developer", "Node.js Developer", "Web Developer Tunisia", "Software Engineer"],
