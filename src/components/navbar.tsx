        ...
        {!isScrolled && (
          ...
          >
            <div className="mx-auto max-w-4xl px-6">
              <div className="mt-3 flex items-center justify-between rounded-2xl py-2 px-3 backdrop-blur-xl bg-background/50 border border-border/20 shadow-sm">
                <Link
                  href="/"
        ...
        {isScrolled && (
          ...
          >
            <Dock
              magnification={50}
              distance={120}
              className="border border-white/20 bg-background/30 dark:border-white/10 dark:bg-background/20 backdrop-saturate-150 shadow-lg"
            >
